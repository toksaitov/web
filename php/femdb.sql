CREATE USER IF NOT EXISTS 'fedmb_user'@'localhost' IDENTIFIED BY '';
CREATE USER IF NOT EXISTS 'femdb_user'@'%' IDENTIFIED BY '';
CREATE DATABASE IF NOT EXISTS `femdb` DEFAULT CHARACTER SET 'utf8';
GRANT ALL PRIVILEGES ON `femdb`.* TO 'femdb_user'@'localhost';
GRANT ALL PRIVILEGES ON `femdb`.* TO 'femdb_user'@'%';
